...
<%@page import="com.xdfn.mode.TbBulletin"%>
<%@page import="com.liuq.common.DateUtil"%>
<%TbBulletin tbull = (TbBulletin)request.getAttribute("ent");%>
...
<table width="1003" height="32" border="0" cellpadding="0" cellspacing="0" bgcolor="#A6A6A6" align="center">
  ...
  <tr>
    <td width="771" height="30" bgcolor="#F6F6F6">&gt; &gt;首页</a> &gt; <span class="font12">公告信息</span></td>
  ...
  <tr>
    <td width="832" valign="top">
        ...
        <table style="word-break:break-all" width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="40" align="center" valign="middle"><p style="text-align: center; line-height: 28pt; margin: 0cm 0cm 6pt; mso-line-height-rule: exactly; mso-para-margin-bottom: .5gd" class="MsoNormal" align="center"><strong style="mso-bidi-font-weight: normal"><span style="font-family: 黑体; font-size: 17pt; mso-font-kerning: 0pt; mso-hansi-font-family: 宋体; mso-bidi-font-family: 宋体"><%=tbull.getVTitle()%><span lang="EN-US"><o:p></o:p></span></span></strong></p></td>
          </tr>
          <tr>
            <td height="24" align="right" valign="middle"><%=DateUtil.parseTimestampToDateStr(tbull.getDPubDate(),"yyyy-MM-dd")%></td>
          </tr>
          <tr>
            <td height="12" valign="bottom">
  <p style="line-height: 20pt; font-size: 14pt; text-indent: 30pt; margin: 0cm 0cm 0pt; mso-pagination: widow-orphan; mso-line-height-rule: exactly; mso-char-indent-count: 2.0" class="MsoNormal"><%=tbull.getVContent()%></p>
  <br>
              <div align="right" style="margin: 10pt 0cm 6pt;">（编辑: <%=tbull.getVPuber()%>）</div>
            </td>
